...
export default function About() {
  return (
    <Layout>
      ...
      {/* Leadership Section */}
      <section className="pb-40 -mt-32 relative z-20">
            ...
            <div className="grid lg:grid-cols-2">
              <div className="relative h-[600px] lg:h-auto overflow-hidden">
                ...
                <div className="absolute bottom-10 left-10 text-white lg:hidden">
                  <p className="text-2xl font-serif font-bold">Mosali Harinadha Reddy</p>
              ...
              <div className="p-12 md:p-24 flex flex-col justify-center space-y-10">
                <div className="space-y-6">
                  ...
                  <h3 className="text-4xl md:text-6xl font-serif font-black text-slate-900 tracking-tighter leading-tight">
                ...
                <div className="grid grid-cols-2 gap-8 pt-6">
                  <div className="space-y-2">
                    <p className="text-4xl font-serif font-black text-primary">20+</p>
                    <p className="text-xs font-black uppercase tracking-widest text-slate-400">Years Experience</p>
                  </div>
                  <div className="space-y-2">
                    <p className="text-4xl font-serif font-black text-primary">10k+</p>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {values.map((value, i) => (
              <motion.div
                key={i}
                whileHover={{ y: -10 }}
                className="bg-white p-12 rounded-[3rem] shadow-xl border border-slate-100 group"
              >
                <div className="w-20 h-20 bg-slate-50 rounded-2xl flex items-center justify-center mb-10 text-primary group-hover:bg-primary group-hover:text-white transition-all duration-500 shadow-inner">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-20">
            <div className="space-y-4">
              <p className="text-6xl md:text-8xl font-serif font-black text-secondary">₹500Cr</p>
              <p className="text-xs font-black uppercase tracking-[0.4em] text-slate-400">Assets Managed</p>
            </div>
            <div className="space-y-4">
              <p className="text-6xl md:text-8xl font-serif font-black text-secondary">98%</p>
              <p className="text-xs font-black uppercase tracking-[0.4em] text-slate-400">Client Retention</p>
            </div>
            <div className="space-y-4">
              <p className="text-6xl md:text-8xl font-serif font-black text-secondary">15+</p>
              <p className="text-xs font-black uppercase tracking-[0.4em] text-slate-400">Bank Partners</p>
            </div>
            <div className="space-y-4">
              <p className="text-6xl md:text-8xl font-serif font-black text-secondary">24h</p>
